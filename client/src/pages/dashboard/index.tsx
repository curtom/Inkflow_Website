...
const ViewsLineChart = lazy(() => import("@/features/dashboard/ui/views-line-chart"));
    ...
    return (
      <div className="space-y-6">
        ...
        <div>
          ...
          <Suspense
            fallback={
              <div className="h-72 rounded-2xl border border-border-cream bg-ivory p-6 text-sm text-stone shadow-whisper">
                Loading chart...
              </div>
            }
          >
